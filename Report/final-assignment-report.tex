...
\section*{Aanpak}
	...
	Vervolgens heb ik alle onderdelen doorgenomen en steeds verbeteringen doorgevoerd.

	De tests zijn hierbij erg waardevol geweest.
	In vrijwel alle gevallen, als de tests sloegen werkte de applicatie via de gebruikersinterface ook.

	De details over de refactoring worden belicht in de volgende secties.
...
\section{Keuzen}\label{sec:keuzen}
    ...
    \TODO{removed versions}
    \TODO{javadoc}
    \TODO{lambdas in controllers}
