...
\section*{Aanpak}
	...
	\todo{Explain diagrams: all methods public, all attributes private}
...
\section{Ontwerp}\label{sec:ontwerp}
	...
	\subsection{View}\label{sec:view}
		...
		\subsubsection{Factories}\label{sec:view-factories}
			...
			\todo{klassen uitleggen. frame vs view}
	...
	\subsection{Controller}\label{sec:controller}
		...
		\begin{figure}[!htb]
		 ...
		 \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Diagrams/controller.pdf}}%
		\end{figure}
		...
		\subsubsection{Factories}\label{sec:controller-factories}
			...
			\begin{figure}[!htb]
			 ...
			 \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Diagrams/controller-factories.pdf}}%
			\end{figure}
