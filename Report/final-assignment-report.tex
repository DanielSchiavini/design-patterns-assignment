...
\section{Keuzen}
    ...
    Dit ontwerp is een geldig alternatief maar er zijn niet veel voordelen.
    De software wordt ingewikkelder en er moeten extra \textit{casts} worden uitgevoerd.
