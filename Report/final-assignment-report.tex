...
\section{Probleemanalyse}
    ...
    \todo{PR voor \reqref{volgnummers} en \reqref{onderwerpen}.}
...
\section{Keuzen}\label{sec:keuzen}
    ...
    De alternatieve klassendiagram wordt in figuur~\ref{fig:design-alternative} getoond.
    \begin{figure}[!htb]
     \caption{
        Alternatieve klassendiagram voor de domein-objecten.\label{fig:design-alternative}
        Sterren geven de nieuwe klasse en methoden aan.
     }
    ...
    De standaard stijl van de inhoudsopgave is niet optimaal.
    Het is niet helemaal duidelijk dat het om een lijst van onderwerpen gaat.
