...
\section{Ontwerp}
	...
	\subsection{Model}
		...
		\begin{figure}[!htb]
		 ...
		 \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Diagrams/model.pdf}}%
		\end{figure}
		...
		\subsubsection{Factories}
			...
			\begin{figure}[!htb]
			 ...
			 \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Diagrams/model-factories.pdf}}%
			\end{figure}
	...
	\subsection{View}
		...
		\begin{figure}[!htb]
		 ...
		 \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Diagrams/view.pdf}}%
		\end{figure}
